...
$items = $MPersoItem->getVentesSemaineAllPerso($idUser, $dateDeb, $dateFin, $limit, array($triRow, $triSens));
...
$nbVente = $MPersoItem->getNbVenteSemaineAllPerso($idUser, $dateDeb, $dateFin);
