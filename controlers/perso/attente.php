<?php
$TPL = new \BFW_Tpl\Classes\Template('perso/attente.html');
...
$items = $MPersoItem->getAttentePerso($idPerso, $limit, array($triRow, $triSens));
...
$nbVente = $MPersoItem->getNbAttentePerso($idPerso);
