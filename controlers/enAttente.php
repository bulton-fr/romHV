<?php
$TPL = new \BFW_Tpl\Classes\Template('enAttente.html');
...
$triRow = substr(post('triRow', 'venteDate'), 7);
...
$items = $MPersoItem->getEnAttente($idUser, $limit, array($triRow, $triSens));
...
$nbVente = $MPersoItem->getNbEnAttente($idUser);
